...
#seurat=readRDS("../20200518/output/COVID-CYTOF/20000/seurat.rds")
seurat<-readRDS("temp/aging-covid/NK/seurat.rds")
#seurat=subset(seurat,idents=c("TC"))
...
seurat <- FindClusters(object = seurat,resolution=1.2, verbose =TRUE)
