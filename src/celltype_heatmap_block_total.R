...
#cts=as.matrix(cts)
pdf("output/covid/Total/total_block_heatmap1.pdf",width=10,height=16)
p=pheatmap(cts,
            border_color=NA,
            show_rownames=T,
            show_colnames=T,
...
pdf("output/covid/Total/total_block_heatmap2.pdf",width=16,height=10)
p=pheatmap(t(cts),
            border_color=NA,
            show_rownames=T,
            show_colnames=T,
