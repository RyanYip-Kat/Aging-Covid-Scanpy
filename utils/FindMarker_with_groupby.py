...
sc.tl.rank_genes_groups(adata,groupby=args.groupby,method="t-test_overestim_var",n_genes=1000,corr_method="bonferroni")
get_rank_group_genes(adata,pval=0.05,fc=0.25,outdir=args.outdir,n_top=50)
get_rank_group_genes(adata,pval=0.05,fc=0.25,outdir=args.outdir)
