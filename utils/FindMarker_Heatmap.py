...
sc.tl.rank_genes_groups(adata,groupby=args.groupby,method='t-test',n_genes=100,corr_method="bonferroni")
...
df=get_rank_group_genes(adata,pval=None,fc=0.25,outdir=args.outdir,n_top=args.n_genes,back=True)
...
sc.pl.heatmap(adata,var_names=genes,groupby=args.groupby,
        ...
        vmin=-3, vmax=3,save=True,figsize=[24,24])
