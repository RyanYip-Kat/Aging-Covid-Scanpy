...
sc.tl.filter_rank_genes_groups(adata,groupby=args.groupby,min_fold_change=0.25) # 0.1 is good
...
sc.pl.rank_genes_groups_heatmap(adata,n_genes=args.n_genes,
        swap_axes=True, vmin=-3, vmax=3,cmap=newcmp,
...
sc.pl.rank_genes_groups_heatmap(adata,n_genes=args.n_genes,
        ...
        show=False,show_gene_labels=True,save="_rank_genes_groups_filtered",figsize=[24,24],dendrogram=False)
