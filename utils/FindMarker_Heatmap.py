...
parser.add_argument("--n_genes",type=int,default=20,help="data")
...
sc.tl.rank_genes_groups(adata,groupby=args.groupby,method='t-test_overestim_var',n_genes=100,corr_method="bonferroni")
