...
class Model(object):
   def __init__(self,path,tcr_path=None,use_harmony=True,n_top_genes=5000,outdir="./scanpy_result"):
      self._path=path
      self._outdir=outdir
   ...
   def _process(self,adata,batch_key=None,remove_doublet=False):
