...
se=SummarizedExperiment(assays=list(counts=count,logcounts=logcount),metadata=metadata)
colData(se)[["label.fine"]]=metadata[["label.fine"]]
colData(se)[["label.main"]]=metadata[["label.main"]]
