...
seurat=readRDS("../20200514/new.Cluster/aging/BC/seurat.rds")
seurat=RenameIdents(seurat,"1"="Naive","3"="Naive","4"="Naive","5"="Naive",
		    "7"="Naive","8"="Naive","9"="Naive","10"="Naive",
		    "17"="Naive","19"="Naive","21"="Naive","0"="Memory",
		    "2"="Memory","6"="Memory","12"="Memory","13"="Memory","15"="Memory",
		    "16"="Memory","20"="Memory","14"="ASC","18"="ASC","11"="ABC")
