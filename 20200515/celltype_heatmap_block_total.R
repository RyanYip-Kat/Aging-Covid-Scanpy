...
seurat=readRDS("../20200514/new.Cluster/aging/Total/seurat.rds")
cts=AverageExpression(seurat,features=markers)[[DefaultAssay(seurat)]]
#cts=as.data.frame(cts)
cts=cts[,c("TC","NK","BC","DC","Mono","Basophil")]
#cts=as.matrix(cts)
pdf("output/aging/Total/total_block_heatmap1.pdf",width=10,height=16)
p=pheatmap(cts,
            border_color=NA,
            show_rownames=T,
            show_colnames=T,
...
pdf("output/aging/Total/total_block_heatmap2.pdf",width=16,height=10)
p=pheatmap(t(cts),
            border_color=NA,
            show_rownames=T,
            show_colnames=T,
