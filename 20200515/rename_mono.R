...
seurat=readRDS("../20200514/new.Cluster/aging/Mono/seurat.rds")
seurat=RenameIdents(seurat,"0"="CD14","1"="CD14","2"="CD14",
		    "3"="CD14","4"="CD14","5"="CD14","6"="CD14","7"="CD14",
		    "8"="CD14","10"="CD14","11"="CD14","12"="CD14","13"="CD14","15"="CD14",
		    "16"="CD14","17"="CD14","19"="CD14","9"="CD16","18"="CD16","14"="Intermed","20"="CD14")
