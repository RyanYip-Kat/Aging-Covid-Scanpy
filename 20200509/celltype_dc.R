...
seurat=readRDS("output/aging/DC/seurat.rds")
seurat=RenameIdents(seurat,"0"="cDC","6"="cDC","9"="cDC","15"="cDC","16"="cDC","1"="cDC","8"="cDC","11"="cDC",
		    "12"="pDC","13"="pDC","14"="pDC","2"="pDC","3"="pDC","4"="pDC","5"="pDC","7"="pDC","10"="pDC")
